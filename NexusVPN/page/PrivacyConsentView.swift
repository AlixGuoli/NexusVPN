    ...
    var body: some View {
        ZStack {
            ...
            GeometryReader { proxy in
                ...
                let topPadding = max(height * 0.08, 32)      // 顶部预留空间，避免贴边
                let cardMaxHeight = height * 0.6             // 卡片最大高度，占屏幕 60%
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    ScrollView {
                        VStack(alignment: .leading) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Button {
                                    if let url = URL(string: "https://fkeysupervpn.xyz/p.html") {
                                        openURL(url)
                                    }
                                } label: {
                    ...
                    .padding(.bottom, max(height * 0.04, 16))
                }
